    ...
    for SEED in SEED_list:
        ...
        for dialog_len in dialog_lens:
            ...
            for personality in personality_list:
                ...
                tsv_files = [
                   '../data/'+DATA+'/'+DATA+'_' + personality + '_with_role_' +str(dialog_len)+ '_' + str(SEED) + '_train.tsv'
                   '../data/'+DATA+'/'+DATA+'_' + personality + '_with_role_' +str(dialog_len)+ '_' + str(SEED) + '_valid.tsv'
                ]
...
#                             print('Current Best Evaluation acc is: ' + str(best_acc) + '\n')
    #                         result_file.write('Current Best Evaluation acc is: ' + str(best_acc) + '\n')
                ...
                test_tsv =  '../data/'+DATA+'/'+DATA+'_' + personality + '_with_role_' +str(dialog_len)+ '_' + str(SEED) + '_test.tsv'
